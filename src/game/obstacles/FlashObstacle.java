...
//        this.attachChild(geom);
        ...
        flash.setImagesX(2); flash.setImagesY(2); // 2x2 texture animation
        flash.setEndColor(  new ColorRGBA(1f, 0.8f, 0.36f, 0f));   // red
        flash.setStartColor(new ColorRGBA(1f, 0.8f, 0.36f, 1.0f)); // yellow
